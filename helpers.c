...
/**
 * start_vars - Initiates varibales
 * @var: Variables
 * Return: 0
 */
...
/**
 * create_instru - Make a instrutuins
 * Return: pointer
 */
...
/**
 * call_funct - Selects function according to opcode
 * @var: variables
 * @opcode: Function to run
 * Return: Void
 */
...
/**
 * _isdigit - Checks if a strings is a digit
 * @string: string to be evaluated
 * Return: 0 if string and -1 if not
 */
